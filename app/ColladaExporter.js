...
THREE.ColladaExporter.prototype = {
	...
	parse: function ( object, write, options = {} ) {
		...
		write(`<library_visual_scenes><visual_scene id="Scene" name="scene">`);
		//var libraryVisualScenes = 
		processObject( object );

		write(`</visual_scene></library_visual_scenes>`);

		write('<scene><instance_visual_scene url="#Scene"/></scene>');
